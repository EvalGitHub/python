...
function(e, t, n) {
    ...
    r.fn.sel.defaults = {
        ...
        {
            val: "zh-CHS2pt",
            liText: "ä¸­æ–‡&nbsp; Â» &nbsp;è‘¡è„ç‰™è¯­",
            liClass: "isfl"
        },
        {
            val: "pt2zh-CHS",
            liText: "è‘¡è„ç‰™è¯­&nbsp; Â» &nbsp;ä¸­æ–‡",
            liClass: "isfl rightBorder"
        }],
...
function(e, t) {
    ...
    var r = function(e) {
        ...
        p = "en",
        h = "zh",
        m = [["'", "â€˜", "â€™"], ['"', "â€œ", "â€"], [",", "ï¼Œ"], [".", "ã€‚"], [";", "ï¼›"], [":", "ï¼š"], ["ã€"], ["Â·"], ["/", "ï¼"], ["?", "ï¼Ÿ"], ["\\", "ï¼¼"], ["|", "ï½œ"], ["`"], ["~", "ï½ž"], ["!", "ï¼"], ["@", "ï¼ "], ["#", "ï¼ƒ"], ["$", "ï¼„"], ["Â¥", "ï¿¥"], ["%", "ï¼…"], ["^", "ï¼¾", "â€¦"], ["&", "ï¼†"], ["_"], ["(", ")"], ["ï¼ˆ", "ï¼‰"], ["[", "]"], ["ï¼»", "ï¼½"], ["{", "}"], ["<", ">"], ["+", "ï¼‹"], ["-", "ï¼"], ["*", "ï¼Š", "Ã—"], ["Ã·"], ["=", "ï¼"]], g = [[10078, 12301, 12303, 12318, 65379], [12305, 12309, 12311, 12313, 12315], [8250, 12297, 12299]], v = {},
...
function(e, t) {
    t.LANGUAGETYPES = {
        AUTO: "è‡ªåŠ¨æ£€æµ‹è¯­è¨€",
        "en2zh-CHS": "è‹±è¯­ &raquo; ä¸­æ–‡",
        "zh-CHS2en": "ä¸­æ–‡ &raquo; è‹±è¯­",
        "ja2zh-CHS": "æ—¥è¯­ &raquo; ä¸­æ–‡",
        "zh-CHS2ja": "ä¸­æ–‡ &raquo; æ—¥è¯­",
        "fr2zh-CHS": "æ³•è¯­ &raquo; ä¸­æ–‡",
        "zh-CHS2fr": "ä¸­æ–‡ &raquo; æ³•è¯­",
        "ko2zh-CHS": "éŸ©è¯­ &raquo; ä¸­æ–‡",
        "zh-CHS2ko": "ä¸­æ–‡ &raquo; éŸ©è¯­",
        "ru2zh-CHS": "ä¿„è¯­ &raquo; ä¸­æ–‡",
        "zh-CHS2ru": "ä¸­æ–‡ &raquo; ä¿„è¯­",
        "es2zh-CHS": "è¥¿è¯­ &raquo; ä¸­æ–‡",
        "zh-CHS2es": "ä¸­æ–‡ &raquo; è¥¿è¯­",
        "pt2zh-CHS": "è‘¡è¯­ &raquo; ä¸­æ–‡",
        "zh-CHS2pt": "ä¸­æ–‡ &raquo; è‘¡è¯­",
        ...
        KR2ZH_CN: "éŸ©è¯­ &raquo; ä¸­æ–‡",
        ZH_CN2KR: "ä¸­æ–‡ &raquo; éŸ©è¯­",
        RU2ZH_CN: "ä¿„è¯­ &raquo; ä¸­æ–‡",
        ZH_CN2RU: "ä¸­æ–‡ &raquo; ä¿„è¯­",
        SP2ZH_CN: "è¥¿è¯­ &raquo; ä¸­æ–‡",
        ZH_CN2SP: "ä¸­æ–‡ &raquo; è¥¿è¯­",
        PT2ZH_CN: "è‘¡è¯­ &raquo; ä¸­æ–‡",
        ZH_CN2PT: "ä¸­æ–‡ &raquo; è‘¡è¯­"
    },
    t.LANGUAGEDESCRIPTIONS = {
        ...
        "æ³•è¯­ Â» ä¸­æ–‡": "fr2zh-CHS",
        "ä¸­æ–‡ Â» æ³•è¯­": "zh-CHS2fr",
        "éŸ©è¯­ Â» ä¸­æ–‡": "ko2zh-CHS",
        "ä¸­æ–‡ Â» éŸ©è¯­": "zh-CHS2ko",
        "ä¿„è¯­ Â» ä¸­æ–‡": "ru2zh-CHS",
        "ä¸­æ–‡ Â» ä¿„è¯­": "zh-CHS2ru",
        "è¥¿è¯­ Â» ä¸­æ–‡": "es2zh-CHS",
        "ä¸­æ–‡ Â» è¥¿è¯­": "zh-CHS2es",
    ...
    t.errorMsg = {
        ...
        20 : "æŠ±æ­‰ï¼Œè¶…è¿‡2ä¸‡å­—å®žåœ¨å¤ªé•¿å•¦ï¼Œè®©æˆ‘å–˜å£æ°”",
    ...
    t.smartSRC = {
        1 : "æœ‰é“è¯å…¸ç»“æžœ",
        2 : "æœ‰é“æ™ºèƒ½ç¿»è¯‘ç»“æžœ",
        3 : "å¾®åšç²‰ä¸çŠ€åˆ©ç¿»è¯‘"
    },
    t.smartText = {
        1 : "æŸ¥çœ‹è¯¦ç»†ç»“æžœ",
        2 : "",
        3 : 'çŒ›å‡»å‚åŠ "æœ‰é“ç¿»è¯‘é¢˜" showå‡ºä½ çš„çŠ€åˆ©'
    }
});
define("/tips",
function(e, t) {
    ...
    t.hide = function(e) {
        ...
        case "all":
            ...
            break;
        case "welcome":
            r("#errorHolder").find(".error_text:contains('æœ‰é“ç¿»è¯‘')").html() && n.fadeOut();
            break;
        case "allExceptWelcome":
            n.find(".error_text:contains('æœ‰é“ç¿»è¯‘')").html() || n.fadeOut()
        }
    },
    t.show = function(e) {
        n.hide(),
        ...
        "è¯·è¾“å…¥å†…å®¹" === e ? n.addClass("nullError") : n.removeClass("nullError"),
        n.fadeIn()
    },
    t.init = function() {
        n = r("#errorHolder"),
...
function(e, t) {
    ...
    t.create = function(t) {
        var r = e("/utils"),
        i = n.browser.msie ? "æ·»åŠ åˆ°æ”¶è—å¤¹": "æ·»åŠ ä¹¦ç­¾",
...
function(e) {
    ...
    n(function() {
        function e() {
            l ? (u.removeClass("sidebarButton-over").attr("title", "å…³é—­å·¦æ å¯¼èˆª"), t.animate(navigator.userAgent.indexOf("MSIE 6") > -1 ? {
                left: 170
            }: {
                left: 0
            }), a.animate({
            ...
            function() {
                a.toggleClass(s)
            }), l = !1, document.cookie = "resultSideCollapse=" + l + ";expires=" + d.toGMTString()) : (u.removeClass("sidebarButton-over").attr("title", "æ‰“å¼€å·¦æ å¯¼èˆª"), t.animate({
                left: -150
            }), a.animate({
                paddingLeft: 20
            },
...
function(e, t) {
    ...
    var r = function() {
        window.clipboardData && (window.clipboardData.clearData(), window.clipboardData.setData("Text", getTranslatedResult()) || alert("æ‚¨çš„æµè§ˆå™¨ä¸æ”¯æŒç›´æŽ¥å¤åˆ¶åŠŸèƒ½ï¼Œè¯·æ‰‹å·¥å¤åˆ¶æˆ–è€…æŸ¥çœ‹å¸®åŠ©ä¸­çš„å¸¸è§é—®é¢˜è¿›è¡Œè®¾ç½®ã€‚"))
    };
    t.init = function() {
        if (! (n("#copyit").length > 0)) if (n.browser.msie) {
            ...
            e.click(function() {
                return r(),
                n(".copy-notice").text("å·²å¤åˆ¶"),
                n(this).text("").blur(),
                setTimeout(function() {
                    n(".copy-notice").text("å¤åˆ¶")
                },
                500),
                !1
            })
...
function(e, t) {
    ...
    u = function() {
        ...
        t ? "è‡ªåŠ¨æ£€æµ‹è¯­è¨€" == r(".btn_text").text() || -1 != r("#outputLang").text().indexOf("æ£€æµ‹åˆ°") ? (r(".btn_text").html(""), r("#outputLang").html("æ£€æµ‹åˆ°ï¼š" + t)) : (r(".btn_text").html(""), r("#outputLang").html(t)) : (r(".btn_text").html("æ£€æµ‹åˆ°ï¼šæš‚ä¸æ”¯æŒçš„è¯­è¨€"), r("#outputLang").html("")),
...
function(e, t) {
    ...
    t.init = function(t, n) {
        ...
        "true" === a.cookie("YOUDAO_FANYI_REALTIME_CLOSE") && (o(".close-realtime-mode").html("å¼€å¯å³æ—¶ç¿»è¯‘"), global.realTime = !1),
        o(".close-realtime-mode").click(function() {
            return global.realTime ? (o(this).html("å¼€å¯å³æ—¶ç¿»è¯‘"), a.cookie("YOUDAO_FANYI_REALTIME_CLOSE", "true"), e("/log").clog("FY_REALTIME_CLOSE", ""), global.realTime = !1) : (o(this).html("å…³é—­å³æ—¶ç¿»è¯‘"), e("/log").clog("FY_REALTIME_OPEN", ""), a.cookie("YOUDAO_FANYI_REALTIME_CLOSE", "false"), global.realTime = !0),
            !1
        }),
...
function(e, t) {
    ...
    p = function() {
        ...
        if (t("baidu.com") || t("google.com") || t("sogou.com") || t("soso.com") || t("so.com") || t("360.cn") || t("haosou.com")) {
            var o = '<strong>æœ‰é“ç¿»è¯‘</strong>&mdash;&mdash;ä¸­å›½æœ€å¤§æœ€ç¨³å®šçš„å…è´¹åœ¨çº¿ç¿»è¯‘ <img id="closeit" class="tip-close" src="http://shared.ydstatic.com/r/1.0/p/x.png" />';
            r.show(o),
    ...
    m = function() {
        ...
        o.showAtButton("", t),
        -1 != n("#outputLang").text().indexOf("æ£€æµ‹åˆ°") && (n(".btn_text").html("è‡ªåŠ¨æ£€æµ‹è¯­è¨€"), n("#outputLang").html(""))
    },
    g = function(e) {
        a.val(h().replace(/\n/g, "").replace(/\r\n/g, ""));
        var t = a.val();
    ...
    v = function(t) {
        ...
        if ("AUTO" != o && p(), n("#wordCurrent").hasClass("beyond")) {
            ...
            m = m.trim(),
            m = m.substr(0, 3),
            r.show("å­—æ•°é™åˆ¶ä¸º5000å­—ï¼Œâ€œ" + m + "â€åŠå…¶åŽé¢æ²¡æœ‰è¢«ç¿»è¯‘!"),
    ...
    b = function(t, n) {
        ...
        var o = h();
        y = o,
        o.length > 0 ? (s.fadeIn(), r.hide("allExceptWelcome"), i.isWeb(o) ? g(n) : v(n)) : (a.focus(), r.show("è¯·è¾“å…¥å†…å®¹"))
    },
    x = function() {
        var e = new Date;
